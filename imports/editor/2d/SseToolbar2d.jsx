...
import {
    ...
    CursorDefaultOutline, DeleteForever, Download, Json, Looks, Redo, Undo, VectorPolygon, Magnet
...
export default class SseToolbar2d extends SseToolbar {
    ...
    componentDidMount() {
        ...
        this.addCommand("iScissorsCommand", "Intelligent Scissors", 1, "I", "iscissors", Magnet);
        ...
        return (
            <div className="hflex flex-justify-content-space-around sse-toolbar no-shrink">
                ...
                <div className="group">
                    ...
                    {this.renderCommand("iScissorsCommand")}
                </div>
                <div className="group">
